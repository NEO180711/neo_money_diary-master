...
NEO가계부에서 낭비성 지출인 C 항목의 구체적인 금액을 한눈에 확인하고, 자신이 불필요하게 지출한 액수를 정확하게 파악합니다. </br>
...
- 한 달 치 가계부를 통해 원형 통계와 리스트형 통계를 제공합니다.
- 리스트표 클릭시 해당 카테고리별로 작성된 가계부 목록을 확인할 수 있습니다.
- 통계는 분류별로 나눠지고, 유형별로도 확인할 수 있습니다.
...
- AI 소비 패턴 리포트, 데이터 쿼리, 월말 잔액 예측, 엑셀/PDF 변환 등 고도화된 분석 기능을 제공합니다.
